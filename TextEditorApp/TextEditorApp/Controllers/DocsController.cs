...
namespace TextEditorApp.Controllers
{
    [Authorize]
    public class DocsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Tittle,Content,UserId")] Doc doc)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Tittle,Content,UserId")] Doc doc)
        {
            if (id != doc.Id)
            {
                return NotFound();
